    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {socialLinks.map((link, index) => (
                <a
                  ...
                  className="flex items-center justify-center p-4 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-300 transform hover:scale-105"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 animate-slide-up" style={{ animationDelay: '600ms' }}>
