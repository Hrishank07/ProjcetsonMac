    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-white to-primary/5 dark:from-[#0F0F0F] dark:via-[#0F0F0F] dark:to-primary/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div 
            ref={formRef}
            className="bg-gradient-to-b from-transparent via-white/50 to-primary/5 dark:via-[#1A1A1A]/50 dark:to-primary/5 rounded-xl p-6 opacity-0 translate-y-10 transition-all duration-700"
          >
            <div className="bg-white/50 dark:bg-[#1A1A1A]/50 backdrop-blur-sm rounded-lg shadow-md p-8 border border-primary/10">
          ...
          <div 
            ref={infoRef}
            className="bg-gradient-to-b from-transparent via-white/50 to-primary/5 dark:via-[#1A1A1A]/50 dark:to-primary/5 rounded-xl p-6 opacity-0 translate-y-10 transition-all duration-700 delay-200"
          >
            <div className="bg-white/50 dark:bg-[#1A1A1A]/50 backdrop-blur-sm rounded-lg shadow-md p-8 border border-primary/10">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">
                Contact Information
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <p className="text-base font-medium text-gray-900 dark:text-white">Social Media</p>
