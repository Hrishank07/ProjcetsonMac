    ...
    <div className="min-h-screen bg-white dark:bg-[#0F0F0F] pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div 
            ref={formRef}
            className="bg-white dark:bg-[#1A1A1A] rounded-lg shadow-md p-8 opacity-0 translate-y-10 transition-all duration-700"
          >
          ...
          <div 
            ref={infoRef}
            className="bg-white dark:bg-[#1A1A1A] rounded-lg shadow-md p-8 opacity-0 translate-y-10 transition-all duration-700 delay-200"
          >
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">
              Contact Information
            </h2>
